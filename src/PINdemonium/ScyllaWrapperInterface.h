...
public:
	...
	UINT32 launchScyllaDumpAndFix(int pid, ADDRINT curEip, string dumpFileName, string tmpDump, bool call_plugin_flag, string plugin_full_path, string reconstructed_imports_file);
